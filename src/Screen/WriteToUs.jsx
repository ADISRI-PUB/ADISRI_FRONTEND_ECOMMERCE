        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
            <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                <div>
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">Contact@Adisri.com</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">D-258, Sector 63, Noida, Uttar Pradesh-201301</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+91 9250052221</p>
                </div>
            </div>
