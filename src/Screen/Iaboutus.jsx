...
function Iaboutus() {
  ...
  return (
    <>
      <div className="bg-[#FFF9E9] relative min-h-screen  ">
        <div className="text-container w-full text-center relative z-20 ">
          <h1 className=" w-3/5 m-auto text-[#7b9272] font-semibold  max-sm:block justify-center">
            About Us
          </h1>
          <h5 className="border-b-2 border-[#7b9272]  border-t-2  w-3/5 max-sm:w-4/5 m-auto italic ">
       ...
       <br />
        ...
        {/* the para text  */}
       <div>
           <h1 className="w-4/5 sm:text-center m-auto leading-loose  border-black text-[20px] max-sm:text-[10px] p-2">
           ...
           <br />
           <div className="sm:h-9 max-sm:hidden"></div>
           <p className="w-4/5 sm:text-center m-auto leading-loose sm:text-[20px] max-sm:text-[10px] p-2 border-black ">
       ...
       <div className="sm:h-20 max-sm:hidden"></div>
        <div className=" grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))]   w-[60%] max-sm:w-[90%] m-auto p-3   sm:gap-y-6 max-sm:gap-y-8 ">
          <div className="relative ">
            ...
            <div className=" w-[80%] bg-[#7b9272] shadow-md m-auto  rounded-br-3xl h-full">
              <p className="text-center text-white font-semibold text-xl max-sm:text-sm p-4 ">
               Customized Corner
              </p>
          ...
          <div className="relative  text-white    ">
            ...
            <div className=" w-[80%] bg-[#7b9272] shadow-md  m-auto sm:h-full rounded-br-3xl    ">
