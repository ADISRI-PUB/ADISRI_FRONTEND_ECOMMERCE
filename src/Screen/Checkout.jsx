...
<div className="grid sm:px-10 col-span-2  w-3/5 max-sm:w-full  m-auto lg:px-20 xl:px-32 relative  ">
  <div className="mt-10 bg-white/20 border-2 border-white rounded-xl text-white backdrop-blur-sm px-4 pt-8 lg:mt-0">
    ...
    <div className="">
      ...
      <div className="relative">
        <input type="text" id="card-holder" name="card-holder" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm uppercase shadow-sm outline-none focus:z-10 focus:border-blue-500 text-black focus:ring-blue-500 " placeholder="Your full school name here" />
      ...
      <div className="flex flex-col sm:flex-row">
        ...
        <select type="text" name="billing-state" className="w-full rounded-md border border-gray-200 px-4 py-3 text-black text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500  text-center" required>
          <option value="" selected disabled hidden >-------State-----</option>
          <option value="New Delhi">New Delhi</option>
          <option value="Noida">Noida</option>
          <option value="Uttar Pardesh">Uttar Pardesh</option>
        </select>
        <input type="number" name="billing-zip" className="flex-shrink-0 text-black rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none sm:w-1/6 focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="ZIP"  required/>
      </div>
