...
//  ANKUSH WORK //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 let {userprofile} =useSelector((state)=>state.user)
  ...
  return (
    ...
    <div className="block ">
      <div className=" z-50 w-full sticky top-0  h-navbar bg-white/50 backdrop-blur-sm  border-white  flex justify-between  max-sm:p-0 max-sm:h-max ">
       <Link to='/' className="float-start  flex logg  w-[22%] max-sm:w-[70%] "> 
       <img
          className="w-[75%] relative left-2 "
        ...
        >
          ...
          <span className="row2 mt-3  h-0.5 max-sm:w-6 transition-all duration-200  block "></span>
          </div>
        </div>

        <div className=" w-[45%] text-[0.8vw] h-full grid grid-cols-5 text-center logg  max-sm:hidden  ">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "bg-[#FBF0D5] rounded-tr-full rounded-tl-full  p-3 transition-all duration-200 h-[90%] relative top-2"
                  : ""
              }
            >
              PRE-PRIMARY
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "bg-[#F7D137]  rounded-tr-full rounded-tl-full  p-3 transition-all duration-200 h-[90%] relative top-2 "
                  : " "
              }
            >
              CONTACT
        ...
        <div className="loginbutton   w-1/6 flex logg justify-center  relative  max-sm:hidden   ">
          ...
          <div className="  w-full justify-center   ">
          {
            flag  ?(
              <>
                <div className="w-4/5 flex m-auto justify-end  relative right-2 float-end  ">
                <div className="space-x-3 flex   ">
                <div  className=" trainsition-all duration-500  space-x-2 relative cursor-pointer bg-blue-600 rounded-lg    flex logg m-auto  justify-center  hover:bg-blue-400 text-black  " onClick={()=>{
                  handleprofile() 
                }
                }>
...
<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"  d="m1 1 4 4 4-4"/>
              ...
              <Link to='/SignIn' className="transition-all duration-200        ">
              <button
...
>
  <div className="flex items-center justify-center bg-white w-[2.1vw] h-[2.1vw] rounded-full">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="" className="w-[1vw] h-[1vw]">
      <path
      fill="#4285f4"
  ...
  <span className="relative  text-[0.8vw] ml-2  ">Sign/Google </span>
</button>
              </Link>
              </div>
            )}
