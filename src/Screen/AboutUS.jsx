  ...
  return (
    <>
      ...
      <div  className="about-sections ">
        <p className="abouttext text-black max-sm:text-xl w-4/5 border-b-2 border-purple-500 m-auto">ABOUT US</p>
        <br />
        <p className="w-4/5 m-auto text-2xl max-sm:text-sm ">Adisri Publications™,an ever evolving name in the sphere of educational publishing in india, We offer enjoyable learning opportunities and memorable reading experience as we strive to imporve the quality of education of the student through reading, writing and drawing.</p>
        <br />
        <br />
