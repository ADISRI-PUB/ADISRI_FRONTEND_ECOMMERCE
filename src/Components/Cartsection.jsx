  ...
  const productdiscard=(id,e)=>{
      let price=0
        let books = arraydata.filter((book)=>{
            if (book.id!=id) {
                price+=book.book_price*book.quantity
                return book
            }
...
<polygon points="456.851,0 245,212.564 33.149,0 0.708,32.337 212.669,245.004 0.708,457.678 33.149,490 245,277.443 456.851,490   489.292,457.678 277.331,245.004 489.292,32.337 "/>
     ...
     <div className="w-2/5  p-4 rounded-xl h-96 max-sm:w-full right-0  logg flex justify-center ">
        ...
        <button className="w-1/2 m-auto  overflow-hidden space-x-2 rounded-full text-center justify-center cursor-pointer p-4 bg-purple-600 hover:bg-purple-400 transition-all duration-200 flex">
