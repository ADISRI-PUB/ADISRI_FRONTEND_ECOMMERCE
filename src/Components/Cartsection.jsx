    ...
    <>
      ...
      {flag ? (
        ...
        <h1 style={{fontSize:"5vw",display:"flex",justifyContent:"center" ,opacity:"0.4"}}>Empty Cart</h1>
           ...
           <Link to="/preprimary" className=" w-1/6"> <button className="p-4  w-full  bg-purple-200 hover:bg-purple-600 transition-all duration-200 hover:text-white    ">SHOP NOW </button></Link>
            </div>
          </div>
        </>
      )}
